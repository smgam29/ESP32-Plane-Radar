...
The uncluttered DMG shows only the installer app, user manual and an explicitly
named `Troubleshooting - Installer Fallback.pdf`; its opening panel directs users
back to the app so it cannot be mistaken for the normal starting point.
